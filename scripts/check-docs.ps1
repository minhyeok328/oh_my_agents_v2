...
$requiredFiles = @(
    ...
    "docs/skills/create-issue/SKILL.md",
    "docs/skills/docs/SKILL.md",
    "docs/skills/epic-to-features/SKILL.md",
    "docs/skills/feature-to-tasks/SKILL.md",
    "docs/skills/refactor-plan/SKILL.md",
    "docs/skills/security-audit/SKILL.md",
    "docs/skills/test-author/SKILL.md",
...
$requiredTextChecks = @(
    ...
    @{ Path = "README.md"; Text = "# oh_my_agents_v2" },
    ...
    @{ Path = "README.md"; Text = "installed skill" },
    @{ Path = "README.md"; Text = "docs/skills" },
    @{ Path = "README.md"; Text = "install-skills.ps1" },
    ...
    @{ Path = "docs/onboarding/USER_GUIDE.ko.md"; Text = "# oh_my_agents_v2" },
    ...
    @{ Path = "docs/agent-rules/context-budget.md"; Text = "## Skill Loading" },
    @{ Path = "docs/agent-rules/context-budget.md"; Text = "Skills used:" },
    ...
    @{ Path = "docs/agent-rules/roles.md"; Text = "skill policy" },
    ...
    @{ Path = "docs/agent-rules/subagent-execution.md"; Text = "Subagents do choose which installed skills apply" },
    ...
    @{ Path = "docs/agent-rules/subagent-execution.md"; Text = "## 5. Skill Selection" },
    @{ Path = "docs/agent-rules/subagent-execution.md"; Text = "Skills used:" },
    ...
    @{ Path = "docs/templates/SUBAGENT_TASK_CARD.template.md"; Text = "## Skill Selection" },
    @{ Path = "docs/templates/SUBAGENT_TASK_CARD.template.md"; Text = "Skills used:" },
    ...
    @{ Path = "docs/templates/SUBAGENT_PROMPTS.md"; Text = 'Every prompt output must include `Skills used:`' },
    ...
    @{ Path = "docs/templates/FULL_DELIVERY_START_CHECKLIST.md"; Text = "Skill policy" },
    ...
    @{ Path = "docs/skills/code-review/SKILL.md"; Text = "name: code-review" },
    ...
    @{ Path = "docs/skills/create-issue/SKILL.md"; Text = "name: create-issue" },
    @{ Path = "docs/skills/docs/SKILL.md"; Text = "name: docs" },
    @{ Path = "docs/skills/epic-to-features/SKILL.md"; Text = "name: epic-to-features" },
    @{ Path = "docs/skills/feature-to-tasks/SKILL.md"; Text = "name: feature-to-tasks" },
    @{ Path = "docs/skills/refactor-plan/SKILL.md"; Text = "name: refactor-plan" },
    @{ Path = "docs/skills/security-audit/SKILL.md"; Text = "name: security-audit" },
    @{ Path = "docs/skills/test-author/SKILL.md"; Text = "name: test-author" },
    @{ Path = "scripts/install-skills.ps1"; Text = "docs/skills" },
    @{ Path = "scripts/install-skills.ps1"; Text = "Installed skill:" },
    ...
    @{ Path = "workspaces/README.md"; Text = "oh_my_agents_v2" },
    @{ Path = "workspaces/README.md"; Text = "profile.md is authoritative" },
    @{ Path = "workspaces/README.md"; Text = "app-local AGENTS.md is optional" },
    @{ Path = "docs/onboarding/examples/LOGIN_SUBAGENT_FLOW.ko.md"; Text = "oh_my_agents_v2" },
